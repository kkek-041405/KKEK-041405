...
export default function PortfolioPage() {
  return (
    <main className="h-screen w-screen overflow-hidden bg-gradient-to-br from-slate-900 via-slate-950 to-black text-slate-300 font-sans">
        ...
        {/* Main Content */}
        <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-x-8 md:h-[calc(100vh-80px)]">
            {/* Left Column */}
            <div className="flex flex-col justify-center space-y-6 md:space-y-0 md:justify-around py-6 md:py-0">
                {/* Hero */}
                <div id="about">
