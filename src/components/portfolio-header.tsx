...
import { Menu, Code2, Download, NotebookText, UserCircle, LayoutGrid, Phone } from "lucide-react"; // Icons for nav links
...
export function PortfolioHeader() {
  ...
  const navLinks = [
    { href: "/#about", label: "About", icon: UserCircle }, // Updated href
  ...
  const isActive = (href: string) => {
    if (href.includes("#")) { // Handle anchor links on the home page
      return pathname === "/" || pathname === href.split("#")[0]; // Active if on home page or specific anchor page
    }
