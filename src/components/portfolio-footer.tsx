    ...
    <footer className="border-t bg-background">
      <div className="container py-10 text-center text-muted-foreground px-4 sm:px-6 md:px-8">
        ...
        <div className="mb-6 flex justify-center gap-x-6 sm:gap-x-8">
          <Link href="https://www.linkedin.com/in/konatham-komal-eshwara-kumar-a253a522a/" aria-label="LinkedIn Profile" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
